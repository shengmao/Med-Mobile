...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MedicalDatamodel06" withExtension:@"momd"];
    NSLog(@"%@",modelURL);
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    //inserts database for coredata
    //NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"medicaldatamodel06.sqlite"];
    NSString* documentsPath = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0];
    NSString *storePath = [documentsPath stringByAppendingPathComponent: @"medicaldatamodel066.sqlite"];
    ...
    if (![fileManager fileExistsAtPath:storePath]) {
        NSString *defaultStorePath = [[NSBundle mainBundle] pathForResource:@"medicaldatamodel066" ofType:@"sqlite"];
        if (defaultStorePath) {
